(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('@angular/common/http'), require('rxjs/operators'), require('types')) :
    typeof define === 'function' && define.amd ? define('api', ['exports', '@angular/core', 'rxjs', '@angular/common/http', 'rxjs/operators', 'types'], factory) :
    (global = global || self, factory(global.api = {}, global.ng.core, global.rxjs, global.ng.common.http, global.rxjs.operators, global.types));
}(this, (function (exports, core, rxjs, http, operators, types) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var ConfigurationService = /** @class */ (function () {
        ...
        function (path) {
            var _this = this;
            return rxjs.combineLatest(this.http.get(path)).pipe(operators.tap((/**
             * @param {?} response
             * @return {?}
             */
            function (response) {
    ...
    var DetailsHttpService = /** @class */ (function (_super) {
        ...
        /** @nocollapse */ DetailsHttpService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function DetailsHttpService_Factory() { return new DetailsHttpService(core.ɵɵinject(http.HttpClient), core.ɵɵinject(ConfigurationService)); }, token: DetailsHttpService, providedIn: "root" });
    ...
    exports.DetailsHttpService = DetailsHttpService;
